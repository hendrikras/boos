...
function getSvgRotatedBy(degrees) {
  return `<svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 493.578 493.578" xml:space="preserve">
  <g id="SVGRepo_iconCarrier"> 
    <g transform="rotate(${degrees} 246.789, 246.789)"> 
...
new p5(function (p5) {
  ...
  p5.setup = function () {
    ...
    if (mobileAndTabletCheck()) {
      const leftSvg = getSvgRotatedBy(0);
      createButton(
        p5,
        inputs,
        { x: -150, y: -100 },
      ...
      const downSvg = getSvgRotatedBy(270);
      createButton(
        p5,
        inputs,
        { x: -50, y: -100 },
      ...
      const rightSVG = getSvgRotatedBy(180);
      createButton(
        p5,
        inputs,
        { x: 50, y: -100 },
      ...
      const upSvg = getSvgRotatedBy(90);
      createButton(
        p5,
        inputs,
        { x: -50, y: -200 },
